...
export const metadata: Metadata = {
  title: 'Sign In - Pizza Dashboard',
  description: 'Sign in to your Pizza Dashboard account',
};
...
export default function SignInPage() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-red-500/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
      <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-pink-500/20 rounded-full blur-3xl animate-pulse delay-500"></div>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-300 text-lg">
              Sign in to your PizzaDash account..
            </p>
          </div>
